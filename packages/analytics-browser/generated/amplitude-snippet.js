...
!function (window, document) {
  ...
  if (amplitude.invoked) window.console && console.error && console.error('Amplitude snippet has been loaded.');else {
    ...
    as.integrity = 'sha384-BQhtsF1IcTmdZrf7CIln2iFx7g70xJwxKMu/zX0tz4UmxQnpJwpUDXir6MbI6niF';
    as.crossOrigin = 'anonymous';
    as.async = true;
    as.src = 'https://cdn.amplitude.com/libs//amplitude-analytics-browser-2.1.0-beta.2-min.js.gz';
    as.onload = function () {
